...
public class TexasScanner extends Scanner {
    ...
    public static final String XPDN_APPID = "1104881083";
    public static final String JPSSZ_APPID = "1104947175";
...
//    public ConcurrentSet< Integer > giveItemIds = new ConcurrentSet<>();
    ...
    public TexasScanner( String name, long beg, long end ) {
        super( name );
        uuid.set( beg );
        uuidEnd = end;
    }
...
//                }
                ...
                if( ( ( 0 < uid && uid <= 10650908L ) || ( 500000000L <= uid && uid <= 500336154L )
                        || ( 600000000L <= uid && uid <= 600003888L ) )
                        && dbClient.incr( key, 1, 1, 0 ) == 1  // 第一次处理
                        && ( TEXAS_APPID.equals( appid ) || HLQP_APPID.equals( appid )
                        || DDZHJ_APPID.equals( appid ) || XPDN_APPID.equals( appid )
                        || JPSSZ_APPID.equals( appid ) ) ) {
