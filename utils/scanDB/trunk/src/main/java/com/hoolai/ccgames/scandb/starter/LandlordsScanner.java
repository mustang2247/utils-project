...
public class LandlordsScanner extends Scanner {
    ...
    public LandlordsScanner( String name, List< Integer > rangeIds ) {
        super( name );
    ...
    protected void shutdown() {
        try {
            type2tpb.forEach( ( type, tpb ) -> {
                ...
                logger.info( "Result GameId:{} Type:{} TopData:{}", GAMEID_LANDLORDS, type, JsonUtil.toString( topPlayers ) );
                centerRepo.setGameTopPlayers( GAMEID_LANDLORDS, type, topPlayers );
            } );
