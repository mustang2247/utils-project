...
public class StringUtil {
	...
	public static String toBinary(int x, int bitCount) {
		String result = Integer.toBinaryString(x);
		int zeroPrefix = bitCount - result.length();
	...
	public static String toBinary(long x, int bitCount) {
